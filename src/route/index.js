...
var header = {
  ...
  salary: '600$ в місяць',
  address: 'г. Одесса, ул. Новосельского, 15',
}
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'ЗОШ № 23 г. Одесса',
          isEnd: true,
        },
        {
          name: 'ЗОШ № 107 г. Одесса',
          isEnd: false,
        },
        {
          name: 'Авто механический техникум г. Одесса',
          isEnd: true,
        },
        {
          name: 'школа IT BRAINS',
          isEnd: false,
        },
      ],
          ...
          projects: [
            {
              ...
              about:
                'Airbnb competitor. High-load application for searching apartment',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                {
                  name: 'I learn the domain and try to understand the idea of the project.',
                },
                {
                  name: 'line - first win / draw / second win, totals etc.',
                },
              ],
